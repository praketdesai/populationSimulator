...
class Archetypes {
    ...
    class Archetype {
        public:
        string name = "Base";
        vector<double> gen_diff = {.95, .79, .92, 1.1, 1, 1.1, 1, 1, 1, 1.2, 1.05, 1}; // generic values
    ...
    Archetypes() {
        ...
        vector<double> lb_gd = {.95, .79, .92, 1.1, 1, 1.1, 1, 1, 1, 1.2, 1.05, 1}; // large boi values
        ...
        vector<double> ln_gd = {.95, .79, .92, 1.1, 1, 1.1, 1, 1, 1, 1.2, 1.05, 1}; // lanky boi values
